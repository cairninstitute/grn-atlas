---
name: grn-subgraph
description: "Extract the induced regulatory subgraph for a set of genes. Returns all known regulatory interactions among the provided genes, useful for visualizing how a gene set is interconnected."
