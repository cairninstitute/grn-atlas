...
def triage_candidates(db, gene_ids: list[str], intent: str = "experiment",
    ...
    for gene_id in _normalize_id_list(gene_ids):
        ...
        ranked.append({
            ...
            "label": gene.get("label") or gene.get("symbol") or gene["id"],
            "label_inferred": bool(gene.get("label_inferred", False)),
...
def prioritize_experiments(db, gene_ids: list[str], intent: str = "experiment",
    ...
    for candidate in triage["ranked_candidates"]:
        ...
        plans.append({
            ...
            "label": candidate.get("label") or candidate.get("symbol") or candidate["gene_id"],
            "label_inferred": bool(candidate.get("label_inferred", False)),
