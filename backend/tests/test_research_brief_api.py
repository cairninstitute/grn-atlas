...
def test_research_brief_returns_workflow(client):
    r = client.post("/api/v1/research/brief", json={"gene_ids": ["TF1", "TG1"], "intent": "experiment"}).json()
    assert r["candidate_brief"]
    assert r["workflow_plan"]
