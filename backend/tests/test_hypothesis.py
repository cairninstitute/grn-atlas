...
def test_hypothesis_compare_ranks_tf1_first(db):
    out = hypothesis.compare_hypotheses(db, ["TF1", "TG1"], intent="experiment")
    assert out["winner"]["gene_id"] == "TF1"
    assert out["runner_up"]["gene_id"] == "TG1"
